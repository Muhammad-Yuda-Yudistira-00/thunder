@foreach($posts as $post)
  <div class="flex items-start gap-2.5 mb-4">
     <img class="w-8 h-8 rounded-full" src="{{ asset('img/user-3.png') }}" alt="Jese image">
     <div class="flex flex-col w-full w-[620px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
